...
const buttonStyles = tv({
  ...
  variants: {
    variant: {
      confirm: 'border-red-300 bg-red-500 disabled:bg-red-500/80 text-white',
      checkout:
        'border-purple-950 bg-purple-900 text-white hover:bg-purple-800 disabled:border-purple-900/50 disabled:bg-purple-900/60',
